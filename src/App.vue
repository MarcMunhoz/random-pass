<template>
  <div id="app">
    ...
    <cite
      >Texto composto por maiúsculas, minúsculas, números e carateres
      especiais.</cite
    >
    <b-card
      class="w-75 mx-auto"
    ...
    >
      <b-card-text
        >Esse emaranhado de letras, símbolos e números pode ser considerado o
        primeiro sistema de defesa ativo de um usuário de determinada
        plataforma. Com o avanço da tecnologia, faz-se necessário senhas mais
        difíceis de serem quebradas. Algumas dicas:
        <b-list-group class="mt-2">
          ...
          <b-list-group-item variant="secondary"
            >Combine letras, números e símbolos</b-list-group-item
          >
          <b-list-group-item variant="secondary"
            >Caso guarde as senhas digitalmente, use sempre
            criptografia</b-list-group-item
          >
          <b-list-group-item variant="secondary"
            >Troque as senhas regularmente</b-list-group-item
          >
          <b-list-group-item variant="secondary"
            >Compartilhe suas senhas apenas com pessoas de sua total
            confiança</b-list-group-item
          >
        </b-list-group>
      </b-card-text>
      <p>
        Para ajuda um pouco, abaixo serão exibidas
        <em>strings</em> geradas de forma randômica. (entre os olhos). Cada 5
