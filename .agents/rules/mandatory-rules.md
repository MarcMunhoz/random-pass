...
Ao criar ou alterar arquivos do OpenSpec:

- Escrever todo conteúdo textual em português do Brasil.
- Manter apenas comandos, paths, nomes de arquivos, código e termos técnicos em inglês quando necessário.
- Não misturar português e inglês em títulos, requisitos, cenários e tarefas.